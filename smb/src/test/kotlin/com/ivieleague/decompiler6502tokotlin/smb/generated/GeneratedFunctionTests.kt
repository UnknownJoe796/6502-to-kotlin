...
class GeneratedFunctionTests {
    ...
    @BeforeTest
    fun setup() {
        // Initialize ROM data before each test
        // This must be called after clearMemory() to ensure ROM tables are loaded
        initializeRomData()
    }
    ...
    fun `moveSpritesOffscreen_frame3_test0`() {
        ...
        // Note: 0x0200 is intentionally NOT written - the function skips sprite 0 (starts at Y=4)
