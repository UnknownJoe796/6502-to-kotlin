...
// Generated with corrected addresses from AddressLabelMapper
// by Claude - regenerated with fixes #6-8 for accurate address calculation

const val A_B_Buttons = 0xA
...
const val AirBubbleTimer = 0x792
...
const val AltEntranceControl = 0x752
...
const val AreaAddrsLOffset = 0x74F
...
const val AreaDataOffset = 0x72C
...
const val AreaMusicBuffer_Alt = 0x7C5
...
const val BehindAreaParserFlag = 0x729
...
const val BlockBufferColumnPos = 0x6A0
...
const val Block_Y_MoveForce = 0x43C
...
const val BridgeCollapseOffset = 0x369
...
const val Bubble_OffscreenBits = 0x3D3
...
const val Bubble_Rel_XPos = 0x3B0
var bubbleRelXPos by MemoryByte(Bubble_Rel_XPos)
const val Bubble_Rel_YPos = 0x3BB
var bubbleRelYPos by MemoryByte(Bubble_Rel_YPos)
const val Bubble_SprDataOffset = 0x6EE
...
const val Bubble_YMF_Dummy = 0x42C
...
const val ChangeAreaTimer = 0x6DE
...
const val CheepCheepOrigYPos = 0x434
...
const val ClimbSideTimer = 0x789
...
const val CloudTypeOverride = 0x743
...
const val CoinTally = 0x75E
var coinTally by MemoryByte(CoinTally)
const val CoinTallyFor1Ups = 0x748
...
const val ColorRotateOffset = 0x6D4
...
const val DeathMusic = 0x1
var deathMusic by MemoryByte(DeathMusic)
const val DeathMusicLoaded = 0x712
...
const val DiffToHaltJump = 0x706
var diffToHaltJump by MemoryByte(DiffToHaltJump)
const val DigitModifier = 0x134
...
const val DuplicateObj_Offset = 0x6CF
...
const val EndOfCastleMusic = 0x8
...
const val EnemyBoundingBoxCoord = 0x4B0
...
const val EnemyIntervalTimer = 0x796
...
const val Enemy_OffscreenBits = 0x3D1
...
const val Enemy_X_MoveForce = 0x401
...
const val Enemy_YMF_Dummy = 0x417
...
const val Enemy_Y_MoveForce = 0x434
...
const val EventMusicBuffer = 0x7B1
...
const val FBall_OffscreenBits = 0x3D2
var fBallOffscreenBits by MemoryByte(FBall_OffscreenBits)
const val FBall_SprDataOffset = 0x6F1
...
const val FetchNewGameTimerFlag = 0x757
...
const val FireballCounter = 0x6CE
...
const val Fireball_Rel_XPos = 0x3AF
var fireballRelXPos by MemoryByte(Fireball_Rel_XPos)
const val Fireball_Rel_YPos = 0x3BA
...
const val FirebarSpinSpeed = 0x388
...
const val FireworksCounter = 0x6D7
...
const val FlagpoleSoundQueue = 0x713
...
const val GameEngineSubroutine = 0xE
...
const val GreenParatroopaJump = 0xE
var greenParatroopaJump by MemoryByte(GreenParatroopaJump)
const val GreyCheepCheep = 0xA
...
const val GroundMusic = 0x1
var groundMusic by MemoryByte(GroundMusic)
const val GroundMusicHeaderOfs = 0x7C7
...
const val HammerEnemyOffset = 0x6AE
...
const val HammerThrowingTimer = 0x3A2
...
const val HorizontalScroll = 0x73F
...
const val JumpspringAnimCtrl = 0x70E
var jumpspringAnimCtrl by MemoryByte(JumpspringAnimCtrl)
const val JumpspringForce = 0x6DB
...
const val JumpspringTimer = 0x786
...
const val LakituReappearTimer = 0x6D1
...
const val Mirror_PPU_CTRL_REG1 = 0x778
var mirrorPPUCTRLREG1 by MemoryByte(Mirror_PPU_CTRL_REG1)
const val Mirror_PPU_CTRL_REG2 = 0x779
...
const val Misc_Rel_XPos = 0x3B3
var miscRelXPos by MemoryByte(Misc_Rel_XPos)
const val Misc_Rel_YPos = 0x3BE
var miscRelYPos by MemoryByte(Misc_Rel_YPos)
const val Misc_SprDataOffset = 0x6F3
...
const val MultiLoopCorrectCntr = 0x6D9
var multiLoopCorrectCntr by MemoryByte(MultiLoopCorrectCntr)
const val MultiLoopPassCntr = 0x6DA
...
const val MushroomLedgeHalfLen = 0x736
...
const val MusicOffset_Noise = 0x7B0
...
const val NoiseDataLoopbackOfs = 0x7C1
...
const val Noise_BeatLenCounter = 0x7BA
var noiseBeatLenCounter by MemoryByte(Noise_BeatLenCounter)
const val Noise_SfxLenCounter = 0x7BF
...
const val OffscreenPlayerInfo = 0x761
...
const val PlatformCollisionFlag = 0x3A2
...
const val Platform_X_Scroll = 0x3A1
...
const val PlayerChangeSizeFlag = 0x70B
...
const val PlayerEntranceCtrl = 0x710
...
const val PlayerGfxOffset = 0x6D5
...
const val Player_BoundBoxCtrl = 0x499
var playerBoundBoxCtrl by MemoryByte(Player_BoundBoxCtrl)
const val Player_CollisionBits = 0x490
...
const val Player_OffscreenBits = 0x3D0
...
const val Player_XSpeedAbsolute = 0x700
var playerXSpeedAbsolute by MemoryByte(Player_XSpeedAbsolute)
const val Player_X_MoveForce = 0x705
...
const val Player_X_Scroll = 0x6FF
...
const val Player_YMF_Dummy = 0x416
...
const val Player_Y_MoveForce = 0x433
...
const val PseudoRandomBitReg = 0x7A7
...
const val RedCheepCheep = 0xB
var redCheepCheep by MemoryByte(RedCheepCheep)
const val RedKoopa = 0x3
...
const val RedPTroopaOrigXPos = 0x401
var redPTroopaOrigXPos by MemoryByte(RedPTroopaOrigXPos)
const val RedParatroopa = 0xF
...
const val RunningSpeed = 0x703
var runningSpeed by MemoryByte(RunningSpeed)
const val RunningTimer = 0x783
...
const val ScrollThirtyTwo = 0x73D
...
const val Sfx_GrowPowerUp = 0x2
var sfxGrowPowerUp by MemoryByte(Sfx_GrowPowerUp)
const val Sfx_GrowVine = 0x4
...
const val Sfx_SecondaryCounter = 0x7BE
...
const val ShellChainCounter = 0x125
...
const val SideCollisionTimer = 0x785
...
const val SprObject_OffscrBits = 0x3D0
...
const val SprObject_YMF_Dummy = 0x416
...
const val SprObject_Y_MoveForce = 0x433
...
const val SprShuffleAmt = 0x6E1
var sprShuffleAmt by MemoryByte(SprShuffleAmt)
const val SprShuffleAmtOffset = 0x6E0
...
const val StaircaseControl = 0x734
...
const val StarFlagTaskControl = 0x746
...
const val StarInvincibleTimer = 0x79F
...
const val StompChainCounter = 0x484
var stompChainCounter by MemoryByte(StompChainCounter)
const val StompTimer = 0x791
...
const val TerrainControl = 0x727
...
const val TimerControl = 0x747
var timerControl by MemoryByte(TimerControl)
const val Timers = 0x780
...
const val TitleScreenModeValue = 0x0
...
const val TopScoreDisplay = 0x7D7
...
const val Tri_NoteLenBuffer = 0x7B8
var triNoteLenBuffer by MemoryByte(Tri_NoteLenBuffer)
const val Tri_NoteLenCounter = 0x7B9
...
const val UndergroundMusic = 0x4
...
const val Up_Dir = 0x8
var upDir by MemoryByte(Up_Dir)
const val Up_Down_Buttons = 0xB
...
const val VerticalScroll = 0x740
...
const val VineStart_Y_Position = 0x39D
...
const val WarmBootValidation = 0x7FF
...
const val WarpZoneControl = 0x6D6
...
const val WorldSelectNumber = 0x76B
...
const val YPlatformTopYPos = 0x401
